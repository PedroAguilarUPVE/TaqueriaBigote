...
public class VentanaPrincipal extends JFrame {
    ...
    private void crearSidebar() {
     ...
     // Botones visibles para todos los roles
        ...
        panelInfoUsuario.setOpaque(true);
        panelInfoUsuario.setBackground(Color.WHITE); 

        panelInfoUsuario.setBorder(BorderFactory.createCompoundBorder(
            BorderFactory.createLineBorder(rosaAcento, 2),
            new EmptyBorder(10, 10, 10, 10)
        ));

        panelInfoUsuario.setPreferredSize(new Dimension(200, 80));
        panelInfoUsuario.setMaximumSize(panelInfoUsuario.getPreferredSize());
